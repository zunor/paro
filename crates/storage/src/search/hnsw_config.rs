...
/// Version 27 makes levelled generation compaction continuously governed
/// maintenance instead of requiring a read-idle window. Immutable wave
/// barriers already reduce maintenance to one build lane under foreground
/// query pressure, so a second query-activity gate only made hot definitions
/// accumulate unbounded graph fan-out.
/// Version 26 separated optional graph-compaction admission from required
/// freshness progress.
...
pub const HNSW_PROVIDER_CONFIG_VERSION: u32 = 27;
