...
use crate::abi::lease::{ColumnBatchLease, LeaseError, LeaseOwnership, LeaseState};

use crate::runtime::data_plane::lease::{CrossDomainReuseStrategy, LeaseReclaimPolicy};
...
#[cfg(test)]
mod tests {
    use crate::abi::lease::LeaseOwnership;

    use crate::runtime::data_plane::lease::LeaseReclaimPolicy;
