...
use crate::logical::plan::{LogicalPlanRead, OwnedLogicalPlan};
...
impl SingletonGroupProof {
    ...
    pub fn from_declared_grouping_key(
        get: &crate::logical::operator::Get,
    ...
    pub fn is_valid_for<Child: crate::logical::plan::LogicalChild>(
        &self,
...
impl InputLayout {
    fn new(input: &impl crate::logical::plan::LogicalInput) -> Option<Self> {
...
fn declared_key_matches(get: &crate::logical::operator::Get, column_ids: &[usize]) -> bool {
...
mod tests {
    ...
    use crate::logical::operator::ExpressionGet;
    use paro_function::aggregate::distributive::count::get_count_star_function;
    use paro_function::aggregate::distributive::minmax::get_max_function;

    fn aggregate_with_reduction() -> Aggregate {
        let child = OwnedLogicalPlan::synthetic(
            crate::logical::operator::LogicalOperator::ExpressionGet(ExpressionGet::new(
                0,
                Vec::new(),
                vec!["key".to_string()],
