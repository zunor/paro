...
fn finish_join_names<Child>(join: &Join<Child>, outputs: &mut Vec<Vec<String>>) -> Vec<String> {
...
fn finish_dependent_join_names<Child>(
    join: &DependentJoin<Child>,
    ...
    fn search_scan_bindings_use_projection_table_index() {
        let search = SearchScan::new(
            ...
            SearchDecision::IndexScan {
                ...
                confidence: crate::logical::operator::Confidence::High,
            },
            vec![Expression::Constant(
