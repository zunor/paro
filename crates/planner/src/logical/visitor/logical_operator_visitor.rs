...
//! Visitor trait over [`crate::logical::operator::LogicalOperator`] and expressions.
...
mod tests {
    ...
    use crate::logical::operator::{EmptyResult, Filter, Join};

    struct RecordingVisitor {
        visited: Vec<crate::logical::plan::PlanNodeId>,
    }
