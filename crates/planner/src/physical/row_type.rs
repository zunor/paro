...
pub enum ColumnIdentity {
    ...
    /// Stable locator for a concrete catalog relation. DML lowering resolves
    /// this identity instead of assuming the locator is the final ordinal.
    Locator {
        object_id: u64,
    },
}
...
impl ColumnIdentity {
    ...
    pub fn is_internal(&self) -> bool {
        matches!(
            self,
            Self::Internal | Self::InternalNamed(_) | Self::Locator { .. }
        )
    }
    ...
    pub fn without_qualifier(&self) -> Self {
        match self {
            ...
            Self::Locator { object_id } => Self::Locator {
                object_id: *object_id,
            },
        }
    }
