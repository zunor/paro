...
use paro_external_abi::{
    AbiLogicalType, ColumnBatchLease, ColumnDescriptor, ColumnEncoding, ColumnLayout,
    ColumnPopulationMode, LeaseOwnership, LeaseState, OffsetWidth, ScalarValueRef,
};
            ...
            vec![
                ColumnDescriptor {
                    ...
                    layout: ColumnLayout::FixedWidth {
                        values: paro_external_abi::BufferLease::host(0, 0, 32, 8),
                        stride: 8,
                    },
                    children: Vec::new(),
                },
                ColumnDescriptor {
                    ...
                    population_mode: ColumnPopulationMode::Eager,
                    nullable: true,
                    validity: Some(paro_external_abi::BufferLease::host(0, 32, 1, 1)),
                    layout: ColumnLayout::VarLen {
                        offsets: paro_external_abi::BufferLease::host(0, 40, 20, 4),
                        data: paro_external_abi::BufferLease::host(0, 64, 64, 1),
