...
mod tests {
    ...
    fn numeric_to_varchar_reads_dictionary_rows() {
        let base = Arc::new(paro_common::test_utils::test_i32_vector_with_allocator(
            &[10, 20, 30],
    ...
    fn uuid_to_varchar_reads_dictionary_rows() {
        let mut base = paro_common::test_utils::test_vector_with_capacity(LogicalType::Uuid, 2);
        base.set_len(2);
        unsafe {
        ...
        let input = paro_common::test_utils::test_dictionary(base, vec![1_u32, 0]);
        let mut result = paro_common::test_utils::test_vector(LogicalType::Varchar);
    ...
    fn varchar_to_json_try_cast_nullifies_invalid_rows() {
        ...
        let mut result = paro_common::test_utils::test_vector(LogicalType::Json);
