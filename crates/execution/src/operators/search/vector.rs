...
impl VectorSearchSourceExec {
    ...
    pub(crate) fn create_local(
        ...
        create_search_local(ctx, global, SearchSourceSpecRef::Vector(&self.spec))
    }
