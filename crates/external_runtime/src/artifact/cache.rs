...
use paro_routine::ResolvedEnvArtifact;

use crate::artifact::gc::{ArtifactGcPolicy, ArtifactLifecycleState};
...
impl ArtifactCache {
    pub fn insert(
        ...
        let state = match artifact.validation {
            paro_routine::ArtifactValidationState::Pending => ArtifactLifecycleState::Pending,
            paro_routine::ArtifactValidationState::Ready { .. } => ArtifactLifecycleState::Ready,
            paro_routine::ArtifactValidationState::Failed { .. } => {
                ArtifactLifecycleState::Draining
            }
        };
        self.entries.insert(
            key,
