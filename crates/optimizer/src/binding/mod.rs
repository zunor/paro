...
use self::column::{ColumnCatalog, ColumnOrigin, ColumnVisibility};
use crate::physical::identity::{ColumnId, StableFingerprintBuilder};
...
pub(crate) struct BindingCatalog {
    identity: self::catalog_identity::CatalogIdentity,
...
impl BindingCatalog {
    pub(crate) fn version(&self) -> self::catalog_identity::CatalogVersion {
    ...
    pub(super) fn intern_reducer_output(
        ...
        paro_planner::physical::scalar_identity::encode_logical_type(&mut key, logical_type);
...
mod tests {
    ...
    fn reducer_domains_are_private_typed_and_transactional() {
        ...
        let relation = crate::cascades::scalar_lowering::intern_column_binding(
