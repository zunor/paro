...
use crate::region::join::cardinality::CardinalityEstimator;
...
/// The SelectivityModel computes the cost of join plans.
///
#[derive(Debug)]
pub(crate) struct SelectivityModel {
...
mod tests {
    ...
    fn leaf(model: &mut SelectivityModel, set: Arc<JoinRelationSet>) -> DPJoinNode {
    ...
    fn test_cost_model_new() {
        let mut cost_model = SelectivityModel::new(SelectivityDefaults::default());
    ...
    fn hash_orientation_uses_materialization_risk_without_repricing_cpu_work() {
        ...
        let mut model = SelectivityModel::new(SelectivityDefaults::default());
        ...
        let conditions = SelectivityModel::condition_profile(node.predicates.as_ref());
