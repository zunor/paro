...
use crate::rewrite::aggregate::semantic_kernels::scalar_kernels_equal;
...
pub(crate) fn prove_selective_projection_inputs<'a>(
    ...
    let sources = by_source
        ...
        .filter_map(|mut source| {
            ...
            let carrier_rows = source_rows(source.source_table_index)
...
pub(crate) fn prove_row_preserving_inputs<'a, Child>(
    ...
    let projected_outputs = checked_projection_indices(projection_map, output.expressions.len())
