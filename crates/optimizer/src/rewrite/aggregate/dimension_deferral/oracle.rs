...
use paro_planner::logical::operator::{Aggregate, ColumnBinding};
use paro_planner::logical::operator::{
    ComparisonJoin, Join, JoinComparisonType, JoinType, LogicalOperator,
};
...
pub(super) enum ExpressionDomain {
    Constant,
    Fact,
    Dimension,
    Mixed,
...
fn recognize(plan: &OwnedLogicalPlan) -> Option<DimensionDeferral> {
    ...
    if crate::estimate::unique_keys::expressions_cover_unique_key(
        &join.left,
